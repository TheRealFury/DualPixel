...
function setup(){
    ...
    leftLimit = createSprite(5, 300, 10, 600);
    leftLimit.shapeColor = 'white';
    rightLimit = createSprite(1295, 300, 10, 600);
    rightLimit.shapeColor = 'white';
}
...
function checkContact(){
    ...
    if(playerBlue.x - leftLimit.x < 10){
        playerBlue.x = leftLimit.x + 10;
    }
    if(playerRed.x - leftLimit.x < 10){
        playerRed.x = leftLimit.x + 10;
    }
    if(rightLimit.x - playerBlue.x < 10){
        playerBlue.x = rightLimit.x - 10;
    }
    if(rightLimit.x - playerRed.x < 10){
        playerRed.x = rightLimit.x - 10;
    }
}
